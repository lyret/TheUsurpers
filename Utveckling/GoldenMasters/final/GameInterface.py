...
class GameInterface:
    ...
    def __init__(self):
        ...
        self.arrowImage      = pygame.image.load(os.path.join('data', 'common', 'panel', 'arrow.png'))
    ...
    #Battle Report
    def showBattleReport(self, attackingArmy, defendingArmy):
        self.titleText = None
        self.bodyText  = None
        self.noteText  = None
        self.linkText  = None
        ...
        for i in range(5):
            ...
            self.bodyText.blit(self.arrowImage, (x-self.arrowImage.get_width()/2,y+120))
