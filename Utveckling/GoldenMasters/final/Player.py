...
class Player:
	...
	def __init__(self, ident, human):
		...
		self.human    = human
		self.intro    = pygame.image.load(os.path.join('data', 'players', self.ident, 'intro.png'))
		self.victory  = pygame.image.load(os.path.join('data', 'players', self.ident, 'victory.png'))
